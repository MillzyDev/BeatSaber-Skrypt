...
UnityEngine::UI::VerticalLayoutGroup* fontLayout;

UnityEngine::GameObject* fontButtonsContainer;
...
TMPro::TextMeshProUGUI* font_title;
std::vector<UnityEngine::UI::Button*> fontVector;
...
void Skrypt::SkryptViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
    ...
    //   ========================== PREVIEW BELOW =============================
        ...
        preview_titleLayout->get_gameObject()->AddComponent<QuestUI::Backgroundable*>()->ApplyBackground(il2cpp_utils::newcsstr("round-rect-panel"));
    ...
    //   ========================== PREVIEW ABOVE =============================
        ...
        info = QuestUI::BeatSaberUI::CreateText(layout->get_transform(), "NOTE: Some changes may require a restart");
